/*! For license information please see main.ee78b23e.js.LICENSE.txt */
!(function () {
  var e = {
      802: function (e, t, n) {
        var r, i, o;
      ...
      463: function (e, t, n) {
        ...
        function Lt(e, t) {
          for (var n = 0; n < e.length; n += 2) {
            var r = e[n],
              i = e[n + 1];
            (i = 'on' + (i[0].toUpperCase() + i.slice(1))), zt.set(r, t), At.set(r, i), u(i, [r]);
          }
        }
        (0, o.unstable_now)();
        var It = 8;
        ...
        var On = i({}, hn, {
          ...
          zn = sn(i({}, dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
          Nn = i({}, gn, {
            deltaX: function (e) {
        ...
        function ar(e, t, n) {
          'focusin' === e
            ? (ir(), (Yn = n), (Gn = t).attachEvent('onpropertychange', or))
            : 'focusout' === e && ir();
        }
        function lr(e) {
        ...
        function la(e, t, n, r, i, o) {
          if (
            ...
            (t.updateQueue = null),
            (t.lanes = 0),
            (Xo.current = null === e || null === e.memoizedState ? za : Na),
            (e = n(r, i)),
            ia)
          ) {
            o = 0;
          ...
          if (
            (null !== i
              ...
              : ((e = e.mutableReadLanes),
                (e = (Zo & e) === e) && ((t._workInProgressVersionPrimary = r), Go.push(t))),
            e)
          )
            return n(t._source);
              ...
              ? (void 0 !== i.fallback && Vo(t),
                ...
                a
                  ...
                  ? ((e = Za(t, e, o, n)),
                    ...
                    (t.lanes = 33554432),
                    e)
                  : (((n = Gs({ mode: 'visible', children: e }, t.mode, n, null)).return = t),
                    (t.child = n)))
              : (e.memoizedState,
                a
        ...
        function hs(e, t, n) {
          ...
          Wt(e, t, n), e === zl && ((Bl |= t), 4 === Dl && ys(e, Ll));
          var r = Hi();
          1 === t
            ? 0 !== (8 & Al) && 0 === (48 & Al)
              ? bs(e)
        ...
        function gs(e, t) {
          ...
          if (((r = Dt(e, e === zl ? Ll : 0)), (t = It), 0 === r))
            ...
            15 === t
              ? ((n = bs.bind(null, e)),
                null === Fi ? ((Fi = [n]), (Ui = _i(Ai, Gi))) : Fi.push(n),
                (n = Mi))
              : 14 === t
        ...
        function vs(e) {
          ...
          var n = Dt(e, e === zl ? Ll : 0);
          if (0 === n) return null;
          var r = n,
            i = Al;
          Al |= 16;
          var o = _s();
          for ((zl === e && Ll === r) || (Kl(), Cs(e, r)); ; )
            try {
              Os();
              break;
            } catch (s) {
        ...
        function js(e, t) {
          ...
          if ((no(), (Al = n), (Rl.current = r), null !== Nl)) throw Error(a(261));
          return (zl = null), (Ll = 0), Dl;
        }
        function Ps() {
          for (; null !== Nl; ) Rs(Nl);
        }
        function Os() {
          for (; null !== Nl && !Pi(); ) Rs(Nl);
        }
        function Rs(e) {
          var t = Ql(e.alternate, e, Il);
          (e.memoizedProps = e.pendingProps), null === t ? Ts(e) : (Nl = t), (Tl.current = null);
        }
        function Ts(e) {
          var t = e;
          do {
        ...
        function As(e) {
          var t = Hi();
          return qi(99, zs.bind(null, e, t)), null;
        }
        function zs(e, t) {
          do {
            Ls();
          ...
          if (
            ...
            if (((i = Al), (Al |= 32), (Tl.current = null), ($r = Gt), vr((l = gr())))) {
            ...
            (Gt = !!$r), (Br = $r = null), (e.current = n), (Gl = r);
            do {
              try {
                for (b = e; null !== Gl; ) {
                  var S = Gl.flags;
                  if ((36 & S && vl(b, Gl.alternate, Gl), 128 & S)) {
                    ...
                    if (null !== C) {
                      var E = Gl.stateNode;
                      Gl.tag, (x = E), 'function' === typeof C ? C(x) : (C.current = x);
                    }
                  }
                  Gl = Gl.nextEffect;
                }
          ...
          if (Zl) (Zl = !1), (es = e), (ts = t);
            ...
            for (Gl = r; null !== Gl; )
              (t = Gl.nextEffect),
                (Gl.nextEffect = null),
                8 & Gl.flags && (((S = Gl).sibling = null), (S.stateNode = null)),
                (Gl = t);
          if (
          ...
          if ((gs(e, Wi()), Yl)) throw ((Yl = !1), (e = Xl), (Xl = null), e);
        ...
        function Ns() {
          for (; null !== Gl; ) {
            ...
            fs ||
              ...
              (0 !== (8 & Gl.flags)
                ? et(Gl, cs) && (fs = !0)
                : 13 === Gl.tag && Pl(e, Gl) && et(Gl, cs) && (fs = !0));
            var t = Gl.flags;
            0 !== (256 & t) && gl(e, Gl),
              0 === (512 & t) ||
                Zl ||
                ...
                if (
                  ...
                  if (null != (e = i.mutableSourceEagerHydrationData))
                    for (i = 0; i < e.length; i += 2)
                      ((o = e[i])._workInProgressVersionPrimary = e[i + 1]), Go.push(o);
          ...
          (t.unstable_scheduleCallback = function (e, o, a) {
            ...
            return (
              ...
              a > l
                ? ((e.sortIndex = a),
                  k(j, e),
                  null === S(_) && e === S(j) && (z ? i() : (z = !0), r(L, a - l)))
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var c = function (e) {
          function t(e, r, s, u, d) {
              ...
              if (
                ...
                switch (h) {
                  case 123:
                              ...
                              e: {
                                for (N = I + 1; N < $; ++N)
                                  switch (s.charCodeAt(N)) {
                                    case 47:
                                      if (42 === h && 42 === s.charCodeAt(N - 1) && I + 2 !== N) {
                                        I = N + 1;
                                        break e;
                                      }
                                      break;
                    ...
                    (H += m), (m = D = M = N = p = 0), (B = ''), (h = s.charCodeAt(++I));
                    break;
                  case 125:
                  case 59:
              ...
              switch (h) {
                ...
                case 10:
                  47 === S
                    ...
                    0 < z * L && l(0, B, r, e, P, j, W.length, u, d, u),
                    (j = 1),
                    P++;
                  break;
                case 59:
            ...
            if (0 < (F = W.length)) {
              if (
                ((M = r),
                0 < z && void 0 !== (x = l(2, W, M, e, P, j, F, u, d, u)) && 0 === (W = x).length)
              )
                return V + W + H;
              if (((W = M.join(',') + '{' + W + '}'), 0 !== R * O)) {
          ...
          function o(e, t) {
            ...
            return (
              (n = e.substring(n + 1, e.length - 1)), N(2 !== t ? r : r.replace(C, '$1'), n, t)
            );
          }
          function a(e, t) {
          ...
          function s(e) {
            return (
              void 0 !== (e = e.prefix) &&
                ((N = null),
                e ? ('function' !== typeof e ? (R = 1) : ((R = 2), (N = e))) : (R = 0)),
              s
            );
          }
          function u(e, n) {
            ...
            var o = t(T, r, n, 0, 0);
            return (
              0 < z && void 0 !== (i = l(-2, o, r, r, P, j, o.length, 0, 0, 0)) && (o = i),
              '',
              (O = 0),
              (j = P = 1),
              o
          ...
          _ = function (t, n) {
            return (function (t, n, r, i) {
              var o = t.attrs,
                ...
                })(Se(n, (0, e.useContext)(ze), l) || w, n, o),
                p = d[0],
                m = d[1],
                g = (function (e, t, n, r) {
                  var i = ce(),
            ...
            p &&
              p.map(function (e) {
                return Object.assign({}, e, {
                  ...
                  pathname: Gt([a, e.pathname]),
                  pathnameBase: '/' === e.pathnameBase ? a : Gt([a, e.pathnameBase]),
                });
              }),
            r,
          );
      ...
      function Lt() {
        return Nt() || Et(!1), (0, e.useContext)(jt).location;
      }
      function It() {
        Nt() || Et(!1);
      ...
      function Ht(e, t) {
        for (var n = e.routesMeta, r = {}, i = '/', o = [], a = 0; a < n.length; ++a) {
          ...
          o.push({
            params: r,
            pathname: Gt([i, c.pathname]),
            pathnameBase: Gt([i, c.pathnameBase]),
            route: f,
          }),
            '/' !== c.pathnameBase && (i = Gt([i, c.pathnameBase]));
        }
        return o;
      }
      function Vt(t, n) {
      ...
      var Pn = /([[\].#*$><+~=|^:(),"'`\s])/g,
        ...
        Xn = {
          onCreateRule: function (e, t, n) {
            return Yn.test(e) ? new Gn(e, t, n) : null;
          },
        },
        Jn = (function () {
          function e(e, t, n) {
      ...
      var Jr = function () {
          ...
          function t(e, t) {
            for (var n = t.split(Gr), r = e.split(Gr), i = '', o = 0; o < n.length; o++)
              for (var a = n[o], l = 0; l < r.length; l++) {
                var s = r[l];
                i && (i += ', '), (i += -1 !== s.indexOf('&') ? s.replace(Yr, a) : a + ' ' + s);
              }
            return i;
          }
          function n(e, t, n) {
      ...
      var zi,
        ...
        Ji = [ji, Pi, Ni, Li, Ii, Mi, Di, Fi, Ui, $i, Bi, Wi, Hi, Vi, Ki, Xi],
      ...
      function io(e, t) {
        if ((void 0 === t && (t = {}), !zi)) return e;
        if (null != to[e]) return to[e];
        ('transition' !== e && 'transform' !== e) || (t[e] = e in zi.style);
        for (var n = 0; n < Zi.length && ((to[e] = Zi[n](e, zi.style, t)), !to[e]); n++);
        try {
          zi.style[e] = '';
        } catch (r) {
          return !1;
      ...
      function _o(e, t) {
        ...
        if (!i.disableGeneration) {
          var l = zr.get(i.sheetsManager, o, r);
          l ||
            ((l = { refs: 0, staticSheet: null, dynamicStyles: null }),
            zr.set(i.sheetsManager, o, r, l));
          ...
          if (0 === l.refs) {
            var c;
            i.sheetsCache && (c = zr.get(i.sheetsCache, o, r));
            var f = o.create(r, a);
            c ||
              ((c = i.jss.createStyleSheet(f, gt({ link: !1 }, s))).attach(),
              i.sheetsCache && zr.set(i.sheetsCache, o, r, c)),
              u && u.add(c),
              (l.staticSheet = c),
      ...
      function Po(e) {
        ...
        if (!r.disableGeneration) {
          var o = zr.get(r.sheetsManager, i, n);
          o.refs -= 1;
          var a = r.sheetsRegistry;
          0 === o.refs &&
            (zr.delete(r.sheetsManager, i, n),
      ...
      function No(e) {
        ...
        function u(e, t) {
          var r = zo.indexOf(t);
          return r === zo.length - 1
            ? s(e)
            : '@media (min-width:'.concat('number' === typeof n[e] ? n[e] : e).concat(i, ') and ') +
                '(max-width:'
                  .concat(
                    (-1 !== r && 'number' === typeof n[zo[r + 1]] ? n[zo[r + 1]] : t) - a / 100,
                  )
                  .concat(i, ')');
        }
        return gt(
      ...
      var Na,
        ...
        Dl,
        Fl,
        Ul = za(e.createElement('path', { d: 'M14 7l-5 5 5 5V7z' })),
        $l = za(e.createElement('path', { d: 'M10 17l5-5-5-5v10z' })),
        Bl = Ze.div(
          Na ||
            (Na = a([
              '\n  margin-top: 10px;\n  display: flex;\n  position: relative;\n  overflow: hidden;\n  ',
        ...
        Ql = Ze.div(
          ...
          rt({ justifyContent: 'start', padding: '130px 50px 0px 30px' }),
        ),
        Gl = Ze.h1(
          $a ||
            ($a = a([
        ...
        Zl = [
          ...
          },
          {
            ...
            title: 'Alternance',
            desc: 'Je recherche un contrat d\u2019apprentissage (12mois: 3jours - 2jours) pour acqu\xe9rir de nouvelles comp\xe9tences et les mettre en pratique.',
            bg: '317256',
          },
          {
            id: 3,
            ...
            children: [
              ...
              (0, an.jsx)(Hl, {
                ...
                children: Zl.map(function (e) {
                  return (0,
                  an.jsx)(Vl, { bg: e.bg, children: (0, an.jsx)(ql, { children: (0, an.jsxs)(Kl, { children: [(0, an.jsxs)(Ql, { children: [(0, an.jsx)(Gl, { children: e.title }), (0, an.jsx)(Yl, { children: e.desc })] }), (0, an.jsx)(Xl, { children: (0, an.jsx)(Jl, { src: e.img }) })] }) }) }, e.id);
                }),
              }),
              (0, an.jsx)(Wl, {
                direction: 'right',
              ...
              children: [
                (0, an.jsx)(Ts, {
                  children: (0, an.jsxs)(As, {
                    children: [
                      (0, an.jsx)(zs, { children: 'HanJun Kim' }),
                      (0, an.jsx)(Ns, { children: '(+33) 6 27 24 46 02' }),
                      (0, an.jsx)(Ls, {
                      ...
                      (0, an.jsx)('button', {
                        ...
                        children: 'Cliquer pour voir le CV',
                      }),
                      (0, an.jsx)('div', {
                        className: 'sns',
                        children: (0, an.jsx)('button', {
                          onClick: function () {
                            return window.open(
      ...
      var fu,
        ...
        zu = [
          { id: 1, img: 'https://ifh.cc/g/e2sVZs.jpg', desc: "Bonjour,  Je m'appelle Jun." },
          {
            ...
            desc: "Apr\xe8s mon service militaire et mon travail dans la s\xe9curit\xe9, j'ai d\xe9cid\xe9 de venir en France sans parler la langue pour d\xe9couvrir ce pays qui m'int\xe9resse depuis longtemps. Je me suis donc inscrit \xe0 des cours de fran\xe7ais et aiv travaill\xe9 dans un grand magasin alimentaire.",
          },
          {
            id: 3,
        ...
        Lu = Ze.div(
          ...
          tt.d18px,
          rt({ fontSize: tt.m16px }),
          rt({ width: '100%', bottom: '150px' }),
          it({ width: '100%' }),
          rt({ width: '100%', justifyContent: 'center', bottom: '-35px' }),
          it({ bottom: '-25px' }),
          ot({ bottom: '-25px' }),
          ...
          (0, an.jsx)(nn, {
            children: (0, an.jsxs)(nt, {
              children: [
                ...
                (0, an.jsxs)(At, {
                  children: [
                    (0, an.jsx)(Rt, { path: '/', element: (0, an.jsx)(Ys, {}) }),
                    (0, an.jsxs)(Rt, {
                      path: 'curriculum',
                      element: (0, an.jsx)(ru, {}),
                      children: [
                        (0, an.jsx)(Rt, { path: '', element: (0, an.jsx)(Nu, {}) }),
...
//# sourceMappingURL=main.ee78b23e.js.map
